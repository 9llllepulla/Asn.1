...
/**
 * Types of date and time of ASN lang: DATE, DATE_TIME, DURATION, TIME, TIME_GEN, TIME_OF_DAY, TIME_UTC
 */
class Time implements GroupableToken {
    ...
    public List<IElementType> getGroupElements() {
        return List.of(DATE, DATE_TIME, DURATION, TIME, TIME_GEN, TIME_OF_DAY, TIME_UTC);
    }
