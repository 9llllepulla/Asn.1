...
import static com.gllllepulla.plugin.psi.AsnTypes.RBRACKET;

/**
 * Types of brackets of ASN lang: "(" and ")", "[" and "]"
 */
class Brackets implements GroupableToken {

    @Override
    public List<GroupingType> groupingTypes() {
        return List.of(GroupingType.BRACKETS);
    }

    @Override
    public String getDescription() {
        return "Types of brackets";
    }
    ...
    public List<IElementType> getGroupElements() {
        return List.of(LPAREN, RPAREN, LBRACKET, RBRACKET);
    }
