...
import static com.gllllepulla.plugin.psi.AsnTypes.COMMENT_HEADER;
import static com.gllllepulla.plugin.psi.AsnTypes.COMMENT_LINE;

/**
 * Types of comments of ASN lang: COMMENT_LINE, COMMENT_HEADER
 */
class LineComment implements GroupableToken {
    ...
    public List<IElementType> getGroupElements() {
        return List.of(COMMENT_LINE, COMMENT_HEADER);
    }
