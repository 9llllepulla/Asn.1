...
public class AsnBodyEnumExprImpl extends ASTWrapperPsiElement implements AsnBodyEnumExpr {

  public AsnBodyEnumExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AsnVisitor visitor) {
    visitor.visitBodyEnumExpr(this);
  }
