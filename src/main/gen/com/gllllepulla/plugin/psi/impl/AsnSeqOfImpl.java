...
public class AsnSeqOfImpl extends ASTWrapperPsiElement implements AsnSeqOf {

  public AsnSeqOfImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AsnVisitor visitor) {
    visitor.visitSeqOf(this);
  }
  ...
  public PsiElement getOf() {
    return findNotNullChildByType(OF);
  }
